...
## 9. Dusto Assistant Home

The home screen should no longer read like a neutral dashboard. It should feel like the moment Dusto wakes up and listens. Keep the overall Apple-inspired restraint, but let the assistant surface feel warmer and more character-led than the utility modules.

### Home Direction
- Use the home screen as the primary chat surface
- Keep the sidebar visible so tools still feel concrete and reachable
- Treat the conversation area as the hero object of the product
- Show the dust character as a companion presence, not a mascot sticker
- Use short suggested prompts as action chips instead of dense dashboard cards

### Layout Guidance
- Split the home into a compact status/header area, a large message transcript, and a grounded composer at the bottom
- Keep the transcript readable in a centered column rather than stretching edge to edge
- Use generous vertical spacing so each assistant exchange feels calm and deliberate
- Surface tool results as tidy cards or inline blocks that look native to the app, not like developer logs

### Visual Guidance
- Preserve the neutral Apple-like base palette, but allow the assistant area to use slightly softer surfaces and character-tinted accents
- Keep the primary accent restrained and purposeful; status, send, and confirm actions should remain visually obvious
- Let empty states feel alive through copy, character illustration, and subtle motion instead of clutter

### Interaction Guidance
- The composer should always feel available and low-friction
- Suggested prompts should help the user discover capabilities such as creating notes, extracting todos, or drafting HTML
- Assistant messages should clearly distinguish between thinking, asking for confirmation, and reporting finished actions
- Confirmation UIs for destructive actions should be explicit and impossible to miss
...
Use these as the canonical mascot variants:

- assets/characters/dust_angry.svg
- assets/characters/dust_cleaner.svg
- assets/characters/dust_crying.svg
- assets/characters/dust_detective.svg
- assets/characters/dust_happy.svg
- assets/characters/dust_hidden.svg
- assets/characters/dust_mini.svg
- assets/characters/dust_ribbon.svg
- assets/characters/dust_shiny.svg
- assets/characters/dust_shy.svg
- assets/characters/dust_sleepy.svg
- assets/characters/dust_surprised.svg

Rules:
- Treat these as soft illustrated SVG characters, not pixel-art sprites
- Preserve the shared dust body silhouette, eye language, gray body palette, and gentle shadow treatment
- Use expressions and small props to communicate state, but keep character moments quiet and supportive
- Do not force pixelated rendering on these assets
- Keep small inline placements subtle, and reserve larger character moments for empty, loading, or onboarding states

State mapping:
- Sidebar brand mark: `dust_mini.svg`
- Assistant idle or empty transcript: `dust_shy.svg`
- Assistant active conversation: `dust_happy.svg`
- Assistant submitting, loading, or export-in-progress: `dust_cleaner.svg`
- Assistant visible error or HTML export error: `dust_surprised.svg`
- Failure-heavy message or failed tool result: `dust_crying.svg`
- Normal confirmation: `dust_detective.svg`
- Destructive confirmation: `dust_angry.svg`
- Completed tool result or successful export: `dust_shiny.svg`
- Cancelled or hidden/unavailable state: `dust_hidden.svg`
- Todo empty state: `dust_sleepy.svg`
- Notes empty or no-selection state: `dust_shy.svg`
- Canvas first-board empty state: `dust_ribbon.svg`
